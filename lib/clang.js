(function() {
    ...
    clang.clientCallback = function(err, result, clangMethodName, args, resourceId, resourceMethod, parentCallback) {
        console.log('SOAP response arrived', arguments);
