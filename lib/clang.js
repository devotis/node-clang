(function() {
            ...
            clang.objects[objectName][methodName] = function(clangMethodName) {
                ...
                return function (args, parentCallback) {
                    ...
                    client[clangMethodName](args, function(err, result) {
                        ...
                        clang.clientCallback(err, result, clangMethodName, undefined, undefined, parentCallback);
                    });
    ...
    clang.clientCallback = function(err, result, clangMethodName, resourceId, resourceMethod, parentCallback) {
        ...
        if (method && method.useResource || //first attempt trying if resource is READY
            ...
            clang.client['resource_getById'](resourceArgs, function(err, result) {
                ...
                */
                clang.clientCallback(err, result, 'resource_getById', resourceId, resourceMethod, parentCallback);
            });
            clang.roundTrips--;
        ...
        if (clangMethodName === 'resource_getById' && result.msg.status === 'READY') {
            ...
            if (result.msg.size > 0) {
                ...
                clang.client[resourceMethod](resourceArgs, function(err, result) {
                    clang.clientCallback(err, result, 'dummy', null, null, parentCallback)
                });
