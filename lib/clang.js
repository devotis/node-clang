...
function Clang(config) {
  ...
  me.config.wsdl = 'https://secure.myclang.com/app/api/soap/public/index.php?wsdl';

  if (!me.config.version) {
    //By default this version is locked
    me.config.wsdl += '&version=1.23';
  } else if (me.config.version !== '*') {
    //Get a specific version by supplying the version number
    me.config.wsdl += '&version=' + me.config.version;
  }
  me.api    = null;
}
